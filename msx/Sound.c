...
{
//	text_print(0, 70,"手前通過？0",rgb2col( 55,255,255),0,0);
  if(Channel<0) return;

	if(SndDriver.SetSound){
		(*SndDriver.SetSound)(Channel,Type);
//	text_print(0, 50,"手前通過？1",rgb2col( 55,255,255),0,0);
	}
//	text_print(0, 60,"手前通過？2",rgb2col( 55,255,255),0,0);
